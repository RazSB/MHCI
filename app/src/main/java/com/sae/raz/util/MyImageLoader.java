...
public class MyImageLoader {
    ...
    public static DisplayImageOptions place_marker_options;
    ...
    public static void showMarker(ImageView imgView, String url, SimpleImageLoadingListener listener) {
        if (TextUtils.isEmpty(url))
            return;

        DisplayImageOptions option = place_marker_options;
        try {
            ImageAware imageAware = new ImageViewAware(imgView, false);
            instance.displayImage(url, imageAware, option, listener);
        } catch (Exception e) {
