...
public class Validation {
    ...
    public static boolean EmptyValidation(String str, String warning_msg) {
        if (str == null)
            return false;
    ...
    // Keyboard and EditText validation module
    public static InputFilter mailFilter = new InputFilter() {
    ...
    public static InputFilter pwdFilter = new InputFilter() {
        public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart, int dend) {
            for (int i = start; i < end; i++) {
